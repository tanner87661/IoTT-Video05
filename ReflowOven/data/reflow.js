...
var slider = document.getElementById("myPWMRange");
...
var chartAccel = new CanvasJS.Chart("chartContainerTempPWM", {
	...
	axisY: {
		title: "Temperature in &deg Celsius",
		includeZero: false,
		suffix: "g"
	},
	legend:{
...
var chartAccel = new CanvasJS.Chart("chartContainerTempPID", {
	animationEnabled: true,
	title:{
		text: "Current Temperature"
	},
